...
(function(d){
    ...
    d.modal.defaults={
        ...
        focus:true,
        opacity:50,
        overlayId:"simplemodalOverlay",
        overlayCss:{},
        containerId:"simplemodalContainer",
        containerCss:{},
        dataId:"simplemodalData",
        dataCss:{},
        minHeight:null,
        minWidth:null,
        maxHeight:null,
    ...
    d.modal.impl={
        ...
        init:function(a,b){
            ...
            if(typeof a==="object"){
                ...
                if(a.parent().parent().size()>0){
                    a.before(d("<span></span>").attr("id","simplemodalPlaceholder").css({
                        display:"none"
                    }));
        ...
        create:function(a){
            ...
            b.d.overlay=d("<div></div>").attr("id",b.o.overlayId).addClass("simplemodalOverlay").css(d.extend(b.o.overlayCss,{
                display:"none",
            ...
            b.d.container=d("<div></div>").attr("id",b.o.containerId).addClass("simplemodalContainer").css(d.extend(b.o.containerCss,{
                display:"none",
                position:"fixed",
                zIndex:b.o.zIndex+2
            })).append(b.o.close&&b.o.closeHTML?d(b.o.closeHTML).addClass(b.o.closeClass):
                "").appendTo(b.o.appendTo);
            b.d.wrap=d("<div></div>").attr("tabIndex",-1).addClass("simplemodalWrap").css({
                height:"100%",
                outline:0,
                width:"100%"
            }).appendTo(b.d.container);
            b.d.data=a.attr("id",a.attr("id")||b.o.dataId).addClass("simplemodalData").css(d.extend(b.o.dataCss,{
                display:"none"
            })).appendTo("body");
        ...
        watchTab:function(a){
            var b=this;
            if(d(a.target).parents(".simplemodalContainer").length>0){
        ...
        close:function(){
            ...
            if(d.isFunction(a.o.onClose)&&!a.occb){
                ...
                if(a.d.placeholder){
                    var b=d("#simplemodalPlaceholder");
                    if(a.o.persist)b.replaceWith(a.d.data.removeClass("simplemodalData").css("display",
                        a.display));
                    else{

...
class header {
    ...
    private static function javascript($nombrePagina) {
        ...
        //incluimos panelSuperior
        $head .= '<script type="text/javascript" src="' . $config->obtenerVariable("carpetaJs") . 'partesFijas/panelSuperior.js"></script>';
        //incluimos panelMenu
        $head .= '<script type="text/javascript" src="' . $config->obtenerVariable("carpetaJs") . 'partesFijas/panelMenu.js"></script>';
